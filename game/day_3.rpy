label day_3:
    ...
    m t BlackSlacks WhiteDress "I must confess I had canned food for days."
    ...
    m t BlackSlacks WhiteDress "We talked about…"
    show miq -t BlackSlacks WhiteDress
    e "Tell me."
    m t BlackSlacks WhiteDress "I-"
    show miq -t BlackSlacks WhiteDress
    e "Ah, I’m sorry. I didn’t mean to sour the mood."
    m t BlackSlacks WhiteDress "It's okay, my sunflower…"
    ...
    m t BlackSlacks WhiteDress "Hey, it’s no biggie deal."
    m "Ah!"
    ...
    m t "Hey, my sunflower. I’ve always wondered if this behavior of yours is normal. If so, it concerns me."
    show miq -t BlackSlacks WhiteDress
    e "Oh, it’s ok."
    ...
    m t BlackSlacks WhiteDress "Hmmm…"
    m "Ok, ok, ok, ok…. O. K."
    ...
    m t BlackSlacks WhiteDress "We’ll be in the information era, my darling Erin.  You will be getting to use a real cell phone."
    show miq -t BlackSlacks WhiteDress
    e "Why would I need such a thing?"
    m t BlackSlacks WhiteDress "Trust me, you’re not mentally prepared to be dragged across more than 50 years into the future."
    show miq -t BlackSlacks WhiteDress
    e "Maybe."
    m t BlackSlacks WhiteDress "Great then."
    show miq -t BlackSlacks WhiteDress
    ...
    e "Miq... I-"
    m t BlackSlacks WhiteDress "Hm?"
    m t BlackSlacks WhiteDress "You're already packed? You’re so quick, hehe."
    m t BlackSlacks WhiteDress "And that is why I love y-"
    show miq -t BlackSlacks WhiteDress
    e "I cannot go."
    m t BlackSlacks WhiteDress "What?"
    m t BlackSlacks WhiteDress "No, you told me you would go with me, even if it meant giving up on a few things."
    show miq -t BlackSlacks WhiteDress
    ...
    m t BlackSlacks WhiteDress "Ok, I understand your reasoning."
    m t BlackSlacks WhiteDress "But never forget, I’m here for you, and if I can’t be by your side, this means you and this town..."
    m t BlackSlacks WhiteDress "Something bad could happen."
    "..."
    show miq -t BlackSlacks WhiteDress
    e "Something really bad happened yesterday, and I’m staying to help my folks..."
    m t BlackSlacks WhiteDress "Ah, very wise, but it still doesn’t make me less worried."
    ...
    m t BlackSlacks WhiteDress "So, is this a goodbye?"
    show miq -t BlackSlacks WhiteDress
    e "I guess so…"
    m t BlackSlacks WhiteDress "Don’t worry, I’ll be back..."
    ...
    m t BlackSlacks WhiteDress "It has been a great experience."
    "I didn’t know whether it was truly a great experience."
    "For me, at least, some could say like a rag doll..."
    "But... I still liked him regardless."
    "Like spring turned into summer and then into autumn, fading into the mist of winter hidden by its crooked branches, which rather than death, indicated renewal of votes against a harsher winter next year."
